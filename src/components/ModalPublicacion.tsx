          ...
          {editando ? (
            ...
            <div className="space-y-4">
              ...
              {post.archivoUrl && post.tipoArchivo === 'image' && (
                <img
                  src={typeof post.archivoUrl === 'string' ? post.archivoUrl : undefined}
                  alt="Imagen subida"
              ...
              {post.archivoUrl && post.tipoArchivo === 'file' && (
                <a
                  href={`https://docs.google.com/viewer?url=${encodeURIComponent(typeof post.archivoUrl === 'string' ? post.archivoUrl : '')}&embedded=true`}
                  target="_blank"
