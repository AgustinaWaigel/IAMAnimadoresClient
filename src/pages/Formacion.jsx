...
export default function Formacion() {
  ...
  return (
    <div className="mx-auto p-10 space-y-8 bg-gradient-to-b from-white to-yellow-100 shadow-lg">
      <button
      ...
      <motion.h1
        ...
        className="font-extrabold text-yellow-400 text-center drop-shadow-lg font-mifuentepersonalizada text-7xl"
      >
        Área de Formación
      </motion.h1>
