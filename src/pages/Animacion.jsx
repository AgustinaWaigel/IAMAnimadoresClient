...
export default function Animacion() {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-slate-50 to-green-100 max-w-6xl mx-auto p-6 space-y-8">
      <button
      ...
      <motion.h1
        ...
        className="font-mifuentepersonalizada text-7xl font-extrabold text-green-600 text-center drop-shadow-lg"
      >
        Área de Animación
      </motion.h1>
