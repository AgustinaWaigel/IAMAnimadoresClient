...
export default function FormatoEscuelaConJesus() {
  const bloques = [
    [
      "Objetivos",
...
>
  ...
  >
    Momentos dentro de un encuentro
  </motion.h1>
  ...
  >
    Los momentos dentro de un Encuentro de la Escuela con Jesús son los siguientes:
  </motion.p>
